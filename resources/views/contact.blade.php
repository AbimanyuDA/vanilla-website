...
<section class="about-section">
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; margin-top: 60px;">
            <!-- Email -->
            <div class="scroll-fade-left" style="background-color: #F29923; padding: 30px; border-radius: 10px; text-align: center;">
            ...
            <!-- Phone -->
            <div class="scroll-scale" style="background-color: #F29923; padding: 30px; border-radius: 10px; text-align: center;">
                <div style="width: 70px; height: 70px; margin: 0 auto 20px; background-color: #FFDD79; display: flex; align-items: center; justify-content: center; border-radius: 50%;">
                ...
                <p style="color: #FFFFFF; font-size: 16px;">+62 858 5366 9568</p>
                <a href="tel:+6285853669568" class="btn btn-outline" style="margin-top: 15px;">Call Now</a>
            </div>

            <!-- WhatsApp -->
            <div class="scroll-fade-right" style="background-color: #F29923; padding: 30px; border-radius: 10px; text-align: center;">
                <div style="width: 70px; height: 70px; margin: 0 auto 20px; background-color: #FFDD79; display: flex; align-items: center; justify-content: center; border-radius: 50%;">
                ...
                <a href="https://wa.me/6285853669568" target="_blank" class="btn btn-outline" style="margin-top: 15px;">Chat Now</a>
            </div>
        </div>

        <!-- Additional Info -->
        <div class="scroll-fade-up" style="margin-top: 60px; text-align: center; max-width: 800px; margin-left: auto; margin-right: auto;">
